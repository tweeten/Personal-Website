...
export const CustomCursor = () => {
  ...
  return <>
      <motion.div className="hidden md:block fixed pointer-events-none z-50 rounded-full border border-[#b75c3d] mix-blend-difference" style={{
      left: 0,
      top: 0,
      ...
      <motion.div className="hidden md:block fixed pointer-events-none z-50 rounded-full bg-[#b75c3d] mix-blend-difference" style={{
      left: 0,
      top: 0,
      width: '4px',
      height: '4px'
