...
export const BlogPreview = () => {
  ...
  return <section className="py-10 md:py-16 bg-[#e6dfd0]/30">
      <div className="container mx-auto px-6">
        <motion.div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-13 md:mb-21 mt-[48px]" initial={{
        opacity: 0,
        y: 30
      }} whileInView={{
        opacity: 1,
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-13">
          ...
          delay: 0.1 * i
              ...
              <div className="p-6 bg-[#f7f3eb] border border-t-0 border-[#b75c3d]/20 h-full">
                ...
                <p className="mt-7 text-[#3c3a36]/80">{post.excerpt}</p>
                <div className="mt-13 inline-flex items-center text-sm text-[#3c3a36] group-hover:text-[#b75c3d] transition-colors duration-300">
